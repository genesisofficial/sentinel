...
# TODO: remove fixtures below here once test_SHIM_serialise_for_genesisd removed
...
@pytest.fixture
def sentinel_governanceblock_hex():
    return ''


@pytest.fixture
def genesisd_proposal_hex():
...
@pytest.fixture
def genesisd_governanceblock_hex():
    return ''

# ========================================================================


def test_SHIM_serialise_for_genesisd(sentinel_proposal_hex, sentinel_governanceblock_hex):
    assert genesislib.SHIM_serialise_for_genesisd(sentinel_proposal_hex) == ''
    assert genesislib.SHIM_serialise_for_genesisd(sentinel_governanceblock_hex) == ''
...
def test_extract_object():
    ...
    expected = {
        ...
        'url': 'https://www.genesiscentral.org/black-pearl',
